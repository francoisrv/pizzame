...
type PizzaMarkerStore = Pick<ReduxState, 'previewedRestaurant'>
...
const connector = (state: ReduxState): PizzaMarkerStore =>
  pick(state, ['previewedRestaurant'])
...
type PizzaMarkerProps = PizzaMarkerStore &
  ...
  return (
    ...
    >
      <div onClick={goToRestaurant}>
        <Typography>{props.previewedRestaurant.name}</Typography>
        <div>
